...
client.on("guildMemberAdd", member => {
      let welcomer = member.guild.channels.find("name","front");
      ...
      const w = ['./IMG_20180808_212752.png'];
...
client.on("ready", () => {
    var guild;
    while (!guild)
        guild = client.guilds.find("name", "!       FRONT")
...
client.on("guildMemberAdd", (member) => {
    let channel = member.guild.channels.find('name', 'front');
    if (!channel) {
